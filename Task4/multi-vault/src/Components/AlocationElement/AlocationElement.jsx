  ...
  return (
    <div className='element-line'>
        ...
        <div className='element-price'>
            <h3 className='element-price-h3'>{"USD "+props.price}</h3>
        </div>
        <div className='element-alocation'>
            <h3 className='element-alocation-h3'>{getAlocation(props.value, props.totalAmount) + "%"}</h3>
        ...
        <div className='element-amount'>
            <h3 className='element-amount-h3'>{props.amount}</h3>
        </div>
        <div className='element-value'>
            <h3 className='element-value-h3'>{"USD " + props.value}</h3>
        </div>
    </div>
  )
}
